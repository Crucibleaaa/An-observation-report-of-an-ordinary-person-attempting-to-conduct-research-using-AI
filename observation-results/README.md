...
| 目录 | 内容 | 说明 |
|---|---|---|
| `papers/` | 正式论文 (44 文件) | token 体系 P0/P1/P2/纲领 + structure_emergence + Case Study + basepoint×3 + conjectures + **算器神魂论筑基篇全套** (ZH/EN md/pdf + 连续统论文 + related_work + 正式版 + MANIFEST.json) |
